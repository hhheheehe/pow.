...
music.addEventListener("error", () => {
  ...
  console.error("Could not load assets/music.mp3", music.error);
});
...
document.getElementById("enterBtn").addEventListener("click", () => {
  // This click is a user gesture, so the browser can normally allow audio playback.
  startMusic();
