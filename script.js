...
async function startMusic(){try{music.volume=0.65;await music.play();musicBtn.textContent="♫ MUSIC: ON";}catch(error){console.log("Music could not start:",error);}}
musicBtn.addEventListener("click",async()=>{if(music.paused){await startMusic();}else{music.pause();musicBtn.textContent="♫ MUSIC: OFF";}});
