...
function startMusic() {
  ...
  if (promise && typeof promise.catch === "function") {
    promise.then(() => setMusicButton(true)).catch((error) => {
...
document.getElementById("enterBtn").addEventListener("click", () => {
  // Start music without waiting for the audio promise. The roster must open
  // even if the browser takes time to load the MP3 or blocks playback.
  startMusic();
