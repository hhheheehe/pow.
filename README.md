...
Browsers block automatic audio on page load. The music is therefore started by the user's click on **CLICK TO SEE ROSTER**, and the music control changes to **ON** after playback actually begins.


## Color theme
Updated to black, white, purple, and subtle blue accents.
